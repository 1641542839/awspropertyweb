...
const Hero = () => {
    return (
        <div className=" w-full relative flex flex-col" style={{height:'70vh'}}>
            <img src={HeroBg} alt="" className="absolute w-full h-full object-cover brightness-[0.2]" />
            <Container classes="flex-1 relative pt-24 flex flex-col gap-4
            md:gap-10 justify-center">
                <h1 className="text-6xl font-semibold text-primary-500 max-w-3xl">
                    Find a <span className="text-accent-500">Prefect Home</span> to live with your family
                </h1>
