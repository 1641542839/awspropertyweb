            ...
            <Container>
                ...
                <div className="mt-20 grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
                    {PROPERTIES.map((property, index) => (
                        <div
                            key={index}
                            className="bg-primary-500 flex flex-col items-center p-10 shadow-md hover:shadow-xl
                            transition-all duration-300"
                        >
                            <property.icon className="text-5xl text-accent-500"/>
                            <h3 className="text-xl text-secondary-500 font-semibold mt-5 text-center">{property.type}</h3>
